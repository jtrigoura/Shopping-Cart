...
import com.BookShoppingCart.JWTConfiguration.ShoppingConfiguration;
import com.BookShoppingCart.service.CartService.CartSerivceImpl;
...
import com.BookShoppingCart.service.CartService.CartService;
        ...
        try {
            ...
            if (cartService.checkTotalAmountAgainstCart(total_amt, user_Id)) {
                ...
                for (AddtoCart addCart : cartItems) {
                    ...
                    cart.setProduct(addCart.getBook());
